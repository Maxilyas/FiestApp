...
**La contre-expertise de performance** (`classement-perf.md`, à côté) : pas de dégradation notable. Rien ne change pendant la question ; la révélation coûte 2 à 4 ms de plus à 500 invités sur la machine de mesure, et 140 à 200 octets par téléphone — dans le bruit sur une vraie salle de 480, où l'instantané renvoyé à chaque révélation pèse 70 Ko par téléphone. Elle a trouvé un recul, corrigé depuis : « sur combien » venait du serveur, dans la place, et exclure un invité pendant une révélation renvoyait sa vue à toute la salle. Il se lit maintenant dans l'instantané, et une épreuve le garde.
