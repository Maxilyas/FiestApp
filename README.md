...
**La carte d'un joueur.** Sur le téléphone, toucher un nom du classement ouvre sa carte : ce qu'il fait ce soir et, s'il a un profil, son niveau, ses légendaires, ses trois plus beaux hauts faits — les plus rares à décrocher, mesurés, avec ce qu'il a fallu faire —, quelques chiffres et le nombre de ses prix de soirée (« 14 sur 20 »). Un invité anonyme a la sienne, sans rien qui dise ce qui lui manque. Le renommage de l'animateur est un **surnom pour la soirée** : il s'affiche partout ce soir-là, le profil garde son prénom, et la carte dit les deux.
