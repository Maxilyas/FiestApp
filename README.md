...
| Mon profil | http://localhost:5173/profil | la même page que l'accueil, en trois onglets : Apparence (ses avatars — emojis, légendaires, Divins —, sa finition et son titre), Trophées (sa vitrine, qu'il choisit, son quiz du jour, ses hauts faits, sa collection de prix), Carrière (sa fiche, ses courbes, ses jours et ses soirées) |
...
| Bilan | http://localhost:5173/demo/bilan | la soirée en cours — et, entre deux soirées, la dernière close : chacun relit ses réponses ; l'animateur y trouve les pages à imprimer, une par invité |
...
Un profil (`/profil`) garde ce qu'on a fait **d'une soirée à l'autre et d'un animateur à l'autre** : de l'expérience, un niveau, des finitions d'avatar. Il se crée depuis l'entrée en deux écrans — le prénom et l'avatar, puis un identifiant et un mot de passe —, ou d'un seul entre deux quiz ou à la fin de la soirée, le prénom et l'avatar du soir déjà remplis, et se retrouve ensuite tout seul. Créé pendant la soirée, il s'y rattache et la soirée compte ; créé après la clôture, il commence à la suivante, et la fin de soirée le dit. Sa page relit chaque soirée jouée sous son titre, avec le bilan de celui qu'on y était, et y ramène d'un toucher à la soirée où l'on joue encore ; on y relit son identifiant et on y change son mot de passe. Si l'identifiant voulu est pris, l'entrée en propose un libre (« camille2 ») qu'on prend d'un geste : un refus sec laisserait debout, dans le noir, quelqu'un qui ne sait pas quoi tenter d'autre.
...
**La carte d'un joueur.** Sur le téléphone, toucher un nom du classement ouvre sa carte : ce qu'il fait ce soir et, s'il a un profil, son niveau, le titre qu'il porte sous son prénom — le nom d'un de ses hauts faits, « L'Oracle », « La Lanterne Rouge » —, ses légendaires, trois de ses hauts faits — ceux qu'il a choisis, sinon les plus rares à décrocher, mesurés —, avec ce qu'il a fallu faire, quelques chiffres, le nombre de ses prix de soirée (« 14 sur 20 ») et son quiz du jour, en une ligne. Un invité anonyme a la sienne, sans rien qui dise ce qui lui manque. Le renommage de l'animateur est un **surnom pour la soirée** : il s'affiche partout ce soir-là, le profil garde son prénom, et la carte dit les deux.

**Les prix de soirée** sont ceux du palmarès de la page souvenir — L'Éclair, Le Cancre Magnifique, Le Franc-Tireur… Il n'y a pas de second catalogue à tenir : ce que la page affiche est exactement ce qui se range sur l'étagère des profils, à la clôture, sur la soirée entière — que l'animateur l'ait remis à l'écran ou non. Un prix ne rapporte **jamais d'expérience**, ni celui du palmarès ni celui qu'on remet à l'écran : l'un se juge sur une seule soirée, l'autre se donne à la main, et aucun des deux ne doit peser sur un niveau. Un prix n'a jamais qu'un lauréat — à égalité parfaite, le plus de matière d'abord, puis l'ordre alphabétique, et la carte du prix le dit : « Ex æquo avec Zoé — départagé par ordre alphabétique » ; La Plus Solidaire, elle, garde l'équipe du mieux classé, et le dit aussi —, et un invité exclu avant la clôture n'y reçoit rien. Retirer une soirée de l'historique reprend tout ce qu'elle avait rapporté.

**Le quiz du jour** (`/jour`, et une carte sur l'accueil) : dix questions par jour, les mêmes pour tous les profils du serveur, tirées à minuit (heure de Paris). On y joue seul, une fois — on reprend si le téléphone sonne —, et l'on apprend : la bonne réponse, la part des joueurs du jour qui l'ont trouvée et l'anecdote arrivent après chaque réponse. Il rapporte l'expérience d'un quiz de soirée de dix questions (75 au plus, à proportion des points), une médaille (bronze à six bonnes réponses, argent à huit, or à dix), une série de jours joués — une soirée compte aussi —, et un podium figé à minuit (25, 15, 10 XP), dans un classement de tout le serveur : aujourd'hui, hier, le mois. Le lendemain raconte la veille et ouvre sa correction. Hauts faits, légendaires, Divins et Éclat restent aux soirées. La réserve s'amorce toute seule avec les quiz livrés qui se jouent seuls ; ensuite, une routine Claude Code l'écrit deux fois par semaine, sur l'abonnement de l'administrateur (MISE-EN-LIGNE.md, étape 8) — le serveur ne détient aucune clé d'IA. À `/admin`, l'administrateur en lit les jours d'avance, peut aussi coller une liste ou copier la consigne dans l'IA de son choix, lit les signalements des joueurs — annuler une question pour tous, la retirer —, et peut masquer un profil du classement.
...
Six sortes de questions, au choix pour chacune :

| Sorte | Comment on répond | Score (200 pts max) |
|---|---|---|
| 🔘 **QCM** | 2 à 4 réponses, une bonne (2 = vrai/faux) | 100 pts si c'est juste + jusqu'à 100 pts de rapidité, le temps de lire offert |
| ☑️ **Plusieurs bonnes réponses** | on coche, puis on valide | comme un QCM — si toutes les bonnes sont cochées, et elles seules |
| 🔀 **À remettre dans l'ordre** | 3 ou 4 réponses, montrées mélangées : on les touche dans l'ordre, puis on valide | comme un QCM — si l'ordre entier est juste |
...
- **Un nombre se tape comme on l'écrit.** « 35 000 », « 12,5 », « −40 » : le téléphone lit une estimation comme l'éditeur lit une liste collée, et le champ « Bonne réponse » garde ce qu'on y tape — il mangeait la virgule de « 0,8 », qui devenait 8 sans un mot. Les champs d'un nombre entier — le temps d'une question, celui d'observation, « Invités au plus », les points d'un prix — se vident aussi : on efface « 20 », il ne revient plus, et le 45 qu'on tape derrière ne fait plus « 2045 ». Les bornes se disent pendant qu'on tape (« de 5 à 120 ») et s'appliquent quand on quitte le champ ; une question dont le temps en sort n'est pas prête. Ce qui ne se lit pas sans deviner (« 10 93 », « 1,000,000 ») le dit à l'invité, au lieu d'être ignoré en silence.
...
- **Coller une liste** évite de saisir cinquante questions une par une. Une ligne vide sépare deux questions, l'étoile marque la bonne réponse, le signe égal crée une estimation (« = ? g » : en direct), et une ligne « # Musique » range les questions qui suivent dans une catégorie. « Type : plusieurs réponses » (une étoile devant chacune des bonnes), « Type : dans l'ordre » (écrites dans le bon ordre) et « Type : qui dans la salle » (rien à écrire dessous) disent les autres sortes ; « Anecdote : », « Note : » et « Intertitre : », ce qui entoure la question. Sous l'intitulé, « Photo : tour-eiffel.jpg » et « Observation : 5 s » règlent la question, dans n'importe quel ordre — jamais pris pour une réponse ; la première ligne, elle, reste toujours l'intitulé. « Temps : 30 s » vaut pour sa question et les suivantes, comme une catégorie, jusqu'à la prochaine ligne « Temps » ; écrite seule en tête, pour tout le quiz. Une réponse mise en forme par une IA se lit comme une liste propre : gras, puces, numéros et lettres (« A) », « B) ») retirés, l'étoile acceptée en fin de ligne, « Réponse : B » sous les choix. Une question sans étoile, ou avec plusieurs, entre sans bonne réponse : elle attend qu'on la choisisse sur sa carte, et ne se joue pas d'ici là. Le nombre d'une estimation se lit comme on l'écrit en France : « = 10 935 mètres » vise 10 935 — milliers séparés par une espace, même insécable ou fine, ou par une apostrophe —, « = 3,14 » a sa virgule, « = −40 °C » son signe moins typographique. Un nombre qui reste ambigu (« = 10 93 mètres », « = 1,000,000 ») compte parmi les blocs ignorés plutôt que d'être mal lu en silence, et l'aperçu montre, pour chaque estimation, la valeur lue en gras et l'unité à côté. La liste arrive à la fin, sauf si on lui donne un numéro : « à partir du n° 41 », et les suivantes se décalent. À l'inverse, **Copier en liste** écrit le quiz dans ce même format, pour le passer dans un message ou le faire compléter : il se recolle tel quel, sauf ses photos, qui reviennent « attendues ». « Coller une liste » est aussi sur la page Mes quiz, où il crée le quiz.
...
- **Exporter, importer.** « Exporter », sur chaque quiz de la liste, télécharge un fichier `.quiz.json` : les questions, et leurs photos et extraits dedans — une adresse `/media/image/…` ne voudrait rien dire ailleurs. « Importer un quiz » le range dans sa bibliothèque, chez un autre animateur du même serveur ou sur un autre serveur. Rien n'entre sans repasser par les portes habituelles : chaque photo par l'envoi d'image (JPEG, PNG ou WebP, poids borné), le quiz par sa création (textes bornés, cent questions au plus). Un fichier qui n'est pas un quiz exporté de l'application est refusé en une phrase, et une photo dans un autre format laissée de côté, pas le quiz (`shared/echange.ts`).
- **🙈 La photo disparaît** transforme n'importe quelle question — QCM comme estimation — en jeu de mémoire. Voir plus bas.
- **🎵 Le blind test.** « Ajouter un son », sur n'importe quelle carte : un extrait en MP3, M4A, OGG ou WAV, d'une trentaine de secondes (1,5 Mo au plus — le navigateur ne sait pas le recompresser comme une photo). L'écran commun le joue dès que la question paraît, « Réécouter l'extrait » le relance, la pause le fige ; les sons coupés, ou sur une télé qui n'a encore vu aucun clic, il attend qu'on le lance. Les téléphones ne le reçoivent jamais : cinquante haut-parleurs décalés, c'est une cacophonie — et une adresse à ouvrir pour tricher.
- **Ce qui entoure une question**, replié sous « Anecdote, note, intertitre » tant qu'il est vide : l'**anecdote** (« Le saviez-vous ? »), racontée à la révélation — à l'écran, au téléphone et dans le bilan, jamais avant ; la **note de l'animateur**, qui ne s'affiche qu'à sa télécommande — ni la télé, ni les téléphones, ni le bilan ; une **photo de la révélation**, distincte de celle de la question (le bébé, puis l'adulte) ; un **intertitre**, une diapo sans réponse avant la question (« Manche 2 : le cinéma », « Pause buvette »), que l'animateur passe d'un clic. **Mise de côté** garde une question écrite sans la jouer.
- **Le hasard d'une partie.** « Régler tout le quiz » : les réponses **mélangées à chaque partie** (par défaut pour un quiz neuf, un modèle ou une liste collée), les questions dans le désordre, ou un **tirage** de N questions par partie — celles jamais posées ici d'abord, puis les plus anciennes : un gros quiz devient une banque de questions. Le tirage se fait une fois pour toute la salle : c'est la copie jouée qui fait foi, à l'écran, aux téléphones, au bilan et dans l'archive. Restent dans l'ordre écrit : le vrai/faux, des réponses toutes numériques (rangées croissantes), et la question marquée « Garder cet ordre » (« Ordre : fixe » dans une liste). L'éditeur signale un quiz dont la bonne réponse est presque toujours la première, et le remède est à un clic (`shared/hasard.ts`).
- **La mémoire des quiz.** La liste dit « joué 3 fois, la dernière le 14 mars », filtre les « Jamais joués » et trie « du dernier joué » ; chaque question dit, au pied de sa carte, « Posée le 14 mars : trouvée par 3 sur 13 (23 %) » — de quoi savoir, en rejouant un quiz, laquelle était trop facile. L'historique le sait depuis ce lot : une soirée d'avant n'en dit rien (`core/memoire.ts`).
- **Une bibliothèque qui se range toute seule.** Une recherche qui lit les titres, les intitulés et les réponses — sans casse ni accent, les mots dans n'importe quel ordre — et dit quelle question a fait trouver le quiz ; des filtres tirés des questions (à compléter, avec photos, avec estimations, par catégorie, jamais joués, archivés) ; le tri du plus récent, de A à Z ou du dernier joué. **Archiver** sort un quiz de la liste et du choix de la soirée sans rien effacer. Chaque ligne s'ouvre d'un clic ; Dupliquer, Exporter, Partager, Archiver et Supprimer sont sous « ⋯ ». « Exporter tous mes quiz » emporte la bibliothèque d'un fichier.
- **Partager, par copie seulement.** Jamais un quiz « public » : vivant, il bougerait sous les pieds des autres ; public, il livrerait ses réponses aux invités qui animent aussi. « Partager par un code » donne un code court (K7X-2QF), valable sept jours et annulable ; l'ami le tape dans « Nouveau quiz → Recevoir par un code » et reçoit une copie du moment du partage, photos et extraits recopiés dans son espace. « Proposer au catalogue » envoie une copie à l'administrateur, qui la relit à `/admin` avant de la publier dans « Partir d'un modèle » de chaque espace. Les modèles livrés sont onze, en deux rayons : pour une fête (tu écris les réponses — « Pour qui ? » remplace le prénom et accorde le modèle d'un geste), et pour jouer tout de suite (`shared/partage.ts`, `core/partages.ts`).
- **L'éditeur dit ce qui manque, et où** : « ⚠ 2 à compléter ↓ » passe d'une question incomplète à la suivante, la durée estimée du quiz s'affiche, un quiz de moins de cinq questions prévient que son podium ne rapportera pas d'expérience, et un emoji que Windows 10 dessine en carré se signale sur la carte. Une photo se colle ou se glisse sur sa carte ; un quiz neuf quitté sans rien y écrire s'efface.

Au tout premier démarrage, les quiz livrés dans `server/content/quiz/*.json` sont importés une fois dans la bibliothèque de l'administrateur pour ne pas partir d'une page blanche. Ensuite ces fichiers ne servent plus à rien : tout vit dans la base. Les autres comptes commencent avec une bibliothèque vide, qui leur propose une copie de ces mêmes quiz (« Partir d'un modèle »), relus du dossier à chaque demande.

## Déroulé d'une partie

L'animateur clique **Lancer un quiz** sur l'écran commun, choisit le quiz, et le 3-2-1 démarre. Pour chaque question : la question s'affiche, chacun répond sur son téléphone, la révélation montre la bonne réponse, la répartition des réponses, le plus rapide et le top 5 — et chaque téléphone, sa place dans la course (voir « Faire durer le suspense »). À la fin, podium — et les points s'ajoutent au **classement de la soirée**, qui survit d'un quiz à l'autre (et à un redémarrage du serveur).

**Le programme de la soirée.** Dans « Mes quiz », le panneau du programme range les quiz de ce soir dans l'ordre, chacun avec son multiplicateur — la finale en ×2, réglée d'avance. À la console, « Lancer un quiz » propose alors le prochain, déjà réglé : un bouton, et c'est parti, avec « Ensuite : la finale ×2 » dessous ; « Un autre quiz… » garde l'improvisation, avec une recherche, et un quiz lancé hors programme ne fait rien sauter. Les programmes se nomment et se gardent d'une soirée à l'autre ; un seul est celui de ce soir. Seuls les écrans d'animateur le reçoivent : la salle ne lit pas le menu (`shared/programme.ts`, `core/programmes.ts`).
...
**Le vidéoprojecteur délave les noirs** : dans une salle éclairée, l'écran commun en fond sombre devient un rectangle gris où plus rien ne se lit. Un bouton de la console le passe en **mode Ivoire** — fond crème, encre sombre, les teintes des pages imprimées du bilan — et l'y ramène : il montre le thème en cours, une lune en Velours, un soleil en Ivoire. Le choix est mémorisé sur le PC de l'animateur et ne concerne que l'écran commun : les téléphones des invités restent sombres, c'est ce qui ménage les yeux dans le noir.

**L'animateur garde la main** : ⏸ pause (le chronomètre se fige, plus personne ne peut répondre), ↺ reposer la même question, ✖ annuler les points d'une question dont la réponse était fausse — l'écran commun comme les téléphones disent alors « Points annulés » —, renommer ou exclure un invité d'un clic sur sa pastille, entre deux quiz — pendant un quiz, le panneau des invités s'efface pour laisser la place à la question —, et ⛶ plein écran. Un invité exclu part avec ses points et ses réponses, et la salle ne l'attend plus. **Qui manque ?** — un bouton de la console, fermé par défaut, parce que la salle n'a pas à lire qui traîne — donne, pendant une question, les prénoms que la salle attend encore, les hors-ligne en tête ; jamais aux téléphones. Un invité hors ligne reste attendu, pour qu'un hoquet de réseau ne fasse pas révéler dans son dos ; mais quand son téléphone est mort, l'animateur peut **ne plus l'attendre**, et la révélation automatique revient — revenu en ligne, il est de nouveau attendu à la question suivante. Il peut aussi lui **rendre sa place** : la console prépare un code à six chiffres, à usage unique, valable trois minutes — caché tant que l'animateur ne clique pas « Montrer le code », puis écrit petit, « à montrer à Rachid, pas à la salle » : la console est peut-être l'écran commun. L'invité le tape sur son nouveau téléphone (« J'ai un code », proposé dès qu'il retape le prénom d'un invité hors ligne — à l'entrée, en salle d'attente, ou entre deux questions s'il s'est déjà réinscrit) et retrouve son prénom, son avatar, son équipe et ses points ; son ancien téléphone, s'il se rallume, repasse par l'entrée. Le second invité qu'il s'était inscrit en attendant s'efface s'il n'a rien joué ; sinon il reste, avec ses points, et on ne l'attend plus — et si sa réponse à la question ouverte attend encore la révélation, la reprise attend avec elle. Pas de code pour un invité à profil : se connecter à son profil lui rend déjà sa place. Les codes faux sont comptés : cinq par minute dans la soirée, sans rien faire tomber. Ces gestes restent là pendant un quiz, quand le panneau des invités s'est effacé. Les clics qui touchent à la question — Révéler, Question suivante, Reposer, Annuler les points — disent laquelle ils visaient : un « Révéler » arrivé juste après la révélation automatique, un double clic, deux écrans animateurs ou une annulation confirmée après que la partie a avancé sont ignorés, au lieu de faire sauter la révélation à la salle ou de retirer les points de la question suivante. Aucun secret ne passe par la barre d'adresse : la session est dans un cookie que le navigateur garde pour lui.

**Suivante : au clic · 5 s · 10 s · 20 s** : en automatique, la question suivante part toute seule après la révélation, avec un décompte affiché. Un quiz de dix questions demandait vingt clics — autant d'occasions de décrocher de la soirée. Cinq secondes laissent lire la bonne réponse, pour un quiz qu'on enchaîne sans le commenter ; dix et vingt, le temps de faire rire la salle ; et « au clic » reprend la main d'un seul geste, comme corriger ou reposer une question. Une question close d'elle-même sans une seule réponse de toute la salle n'enchaîne pas : la suite attend le clic, et l'écran dit pourquoi — une coupure, le 24 septembre, avait fait jouer trois questions et un podium devant une salle vide. « Personne » est pris au mot : une salle présente qui sèche sur une question s'arrête aussi, et à la dernière question, c'est le podium qui attend le clic. Le mode reste choisi, et repart dès qu'une question reçoit une réponse ; pendant l'attente, retoucher le palier allumé relance aussitôt l'enchaînement. Le réglage vaut pour la soirée : le quiz suivant le reprend, et la clôture l'oublie.

**Animer debout : la télécommande.** Sur un téléphone tenu droit, `/host` devient une télécommande — le bouton 📱 de la console bascule, et le choix est retenu : les gestes de la soirée en grand (lancer, révéler, suivante, pause, prix, victoire, clôture), la question sans sa réponse, et sous la main les coulisses — la liste des quiz, la grille des prix, les invités et les équipes. La télé suit : le podium de la soirée, la remise des prix, la victoire et la clôture sont une **scène tenue par le serveur**, que tous les écrans d'animateur de l'espace montrent, d'où qu'on les ouvre. Tant qu'une télécommande est branchée, la télé garde ses coulisses pour elle : pendant le choix du quiz, « Le prochain quiz arrive… » ; pendant les prix, le dernier prix remis, en grand, et le classement des équipes qu'il vient de changer — même si le téléphone se verrouille un instant. « Choisir d'ici » et « Remettre les prix d'ici », à la console de la télé, les lui rendent pour la scène en cours. Un écran de fin ne s'ouvre pas par-dessus une question, et la clôture quitte la télé dès que la soirée suivante commence (un premier invité, un premier quiz). Pour **brancher la télé**, on ouvre `/host` sur elle : à côté de la connexion, elle affiche un code de six signes ; « Brancher la télé », à la télécommande, le valide, et la télé s'ouvre sur l'espace — sans rien taper à sa télécommande. Le code sert une fois et périme en cinq minutes ; la session de la télé dure une soirée (24 heures au plus, sans se prolonger) et tombe avec celle du profil qui l'a validée. Comme tout animateur du serveur peut valider le code affiché, la télé dit en salle d'attente par qui elle a été branchée, avec un bouton « Débrancher ».
...
De ce journal sortent **une vingtaine de prix**, calculés tout seuls : ⚡ L'Éclair (le plus rapide en moyenne), 🐢 Le Contemplatif (le plus lent, mais juste), 🔫 La Gâchette Facile (vite et faux), ⏰ Le Buzzer de Fin, 💯 Le Plus Précis, 🙃 Le Cancre Magnifique, 😴 L'Abstentionniste, 🔥 L'Invincible, 🌚 La Série Noire, 🔮 Le Compas dans l'Œil, 🎈 L'Optimiste, 🌧️ Le Pessimiste, 🎯 Le Pile-Poil, 🦄 Le Franc-Tireur, 🐑 Le Mouton, ✋ Le Doigt qui Tremble, 🦸 Le Sauveur, 📈 La Remontada, 📉 La Chute Libre, 👁️ L'Œil de Lynx, plus deux prix d'équipe : 🤝 Le Coup de Pouce et ⚖️ La Plus Solidaire. L'Abstentionniste se propose à 0 point, pour l'honneur — un point d'équipe pour avoir laissé passer les questions, c'était récompenser l'absence —, et Le Coup de Pouce revient à l'équipe de celui qui a le moins marqué parmi ceux qui ont joué.
...
**Les pages à imprimer** (`…/bilan/fiches`) enchaînent une page par invité, en Ivoire, chacune sur sa page : « Imprimer » puis « Enregistrer en PDF », et on envoie à chacun la sienne — ou on imprime le tout.
...
L'application sert plus d'une soirée. **`/demo/soirees`** liste les soirées passées de l'espace, et chacune se relit avec les mêmes pages que la soirée en cours : `/demo/soirees/<id>/souvenir`, `/demo/soirees/<id>/bilan` — et les pages à imprimer avec. Les pages disent en tête quelle soirée elles relisent.

**La soirée s'enregistre toute seule** dans l'historique après chaque quiz : plus rien ne dépend d'un « Sauvegarder » auquel l'animateur pense, ou pas. En cours, elle s'affiche à part, « en cours », sous le titre qu'elle porte déjà. **Clore la soirée** (écran commun, sur l'accueil et après l'écran de victoire) est le seul geste de fin : la soirée se range une dernière fois, sous le titre qu'on lui donne ; ce qui ne se décide qu'à la fin est crédité — podium de la soirée, prix, hauts faits, paliers, avatars légendaires ; chaque téléphone reçoit sa **fin de soirée** — son rang, ses prix, ses hauts faits, ce que son profil y a gagné, et, même les soirs où rien ne tombe, ses records battus, les objectifs dont il s'approche (« La Foudre : 7 fois sur 10 · +1 ce soir ») et les prix qui entrent dans sa collection, avec « Mon bilan » ouvert sur lui et un lien pour la relire ; elle se garde sur le téléphone, et le retour du navigateur ou un rechargement la retrouvent — et l'écran commun annonce la soirée à la salle — l'équipe qui l'emporte comprise —, avant que la suivante ne parte de zéro. Entre les deux, le souvenir et le bilan de l'espace montrent la soirée close : `recap.json` et `bilan.json` la désignent (`derniere`) tant que la suivante n'a rien joué. Un téléphone qui dormait pendant la clôture retrouve sa fin de soirée à son réveil ; si le serveur a redémarré entre-temps, il apprend au moins que la soirée est close, et l'entrée propose de la revoir. Le lendemain, l'entrée de l'espace et l'accueil proposent, en une ligne, « La dernière soirée : le souvenir · mon bilan » — celle que ce téléphone a gardée. À la clôture, la console ouvre le souvenir, le bilan, les fiches, l'historique, et copie le lien de l'archive — celui qui ne changera pas quand la suivante jouera ; sur le bilan, l'animateur trouve « Tous les liens », un bilan par invité, à coller dans le groupe. Rien ne s'efface tant que rien ne s'est écrit au loin : si la base distante ne répond pas, la soirée reste là, entière, et l'animateur le lit. **C'était un essai**, à côté, efface tout sans rien garder — l'archive que la soirée s'était faite, et tout ce qu'elle avait crédité aux profils.

Une soirée rangée plusieurs fois est mise à jour, pas dupliquée : c'est la date et l'heure de sa **première question jouée** qui l'identifient — dans l'espace, deux animateurs peuvent avoir joué le même soir sans se gêner. Ce nom se tire une fois pour toutes — au plus tard quand quelque chose s'écrit sous lui dans la base permanente —, puis il est gardé, miroir compris : exclure le premier arrivé, presque toujours le téléphone d'essai de l'animateur, ou redémarrer le serveur ne le change plus. Seules la clôture et « C'était un essai » l'oublient ; la soirée suivante en tire un nouveau. L'arrivée d'un invité ne la date pas : l'invitée revenue relire la veille, ou le QR testé la veille par l'animateur, inscrivaient un invité le 17 — et même s'il jouait le 24, la soirée s'archivait « du 17 ». Il se recalculait à chaque besoin, et une exclusion entre deux quiz rebaptisait la soirée : l'expérience s'écrivait sous deux noms et s'additionnait, et la soirée apparaissait deux fois dans l'historique.

Une archive est une copie complète — invités, équipes, points, prix remis, journal des réponses, et les quiz tels qu'ils ont été posés — rangée dans la base permanente, à côté de la bibliothèque. Rien n'y est précalculé : le souvenir et le bilan se relisent depuis ces données avec le code du jour, et une amélioration des prix ou du bilan profite aux soirées passées. La liste de l'historique aussi : chaque soirée y garde une fiche de faits bruts — les invités dans l'ordre d'arrivée avec leur prénom, leur avatar, leur équipe et leurs points, les équipes, les prix, le nombre de quiz et de questions —, dont le résumé se redérive à chaque lecture avec les règles du souvenir : marques d'homonymie, ex æquo couronnés ensemble, équipe gagnante prix compris. Une fiche pèse quelques Ko quand une archive pèse jusqu'à plusieurs Mo : la liste s'affiche sans relire les archives. Une soirée rangée avant les fiches — ou avant leur troisième version, qui garde ce que la moyenne des équipes lit question par question — voit la sienne écrite à sa première lecture. Les quiz voyagent avec l'archive : on peut ensuite retoucher la bibliothèque, ou la réécrire pour la soirée suivante, sans rien perdre.

Sur `/demo/soirees`, l'animateur de l'espace — connecté à son compte — renomme une soirée ou la retire de l'historique. L'export sait viser une archive : `npm run export -- https://ton-app.onrender.com --slug demo --soiree 2027-03-14-k7x2q-3fz81a` (l'identifiant est dans l'adresse de ses pages) écrit ses fichiers dans `export/demo/2027-03-14-k7x2q-3fz81a/`.
...
**Sa place, à chaque révélation.** Le top 5 de l'écran commun ne parle qu'à cinq invités ; les autres ne lisaient que « Total quiz : 450 pts · 3ᵉ place », en petit sous l'anecdote. Chaque téléphone dit maintenant, sous le résultat, en trois lignes courtes : de quel classement il s'agit et ce qui reste à jouer (« Ce quiz ×2 · encore 6 questions »), sa place (« 5ᵉ place sur 12 · 450 pts », avec ↑ 2 s'il a gagné des places depuis la question d'avant), et **une cible nommée** — « À 40 pts d'Hugo », le plus proche strictement devant, « et 2 autres » s'ils sont ex æquo ; le meneur, lui, lit « Hugo te suit à 40 pts », et « Tu prends la tête ! » la question où il passe devant. Un duel par invité, là où quarante-sept sur cinquante regardaient une course perdue d'avance. **Il ne dit que les bonnes nouvelles** : la flèche ne monte que vers le haut, « sur 12 » ne s'écrit qu'à la moitié haute du classement, jamais « dernier », et pas de rang à zéro point — « Pas encore de points », avec la cible à rattraper, ou « Personne n'a encore marqué ». Le lecteur d'écran entend une phrase, « rang 5 sur 12, 450 points, 2 places gagnées ». Les équipes viennent juste dessous et restent au premier écran d'un téléphone de 640 px ; l'anecdote, que la télé montre en grand, passe après. Au podium du quiz, qui n'y monte pas voit l'échelle de ses voisins — celui qu'il talonnait, lui, celui qui le talonnait — et « À 20 pts du podium » s'il en était tout près ; dès le deuxième quiz de la soirée, une ligne dit sa place à la soirée. Rien pendant la question : les points ne tombent qu'à la révélation. Le rapport d'expert qui a tranché tout ça est dans `retours/2026-09-25/classement-en-cours.md`.
...
**Rejoindre son équipe.** L'inscription se fait en deux écrans : prénom + avatar, puis l'équipe. Le deuxième n'apparaît que si l'animateur a créé des équipes ; sinon on rejoint directement, comme avant. Chaque équipe y montre les prénoms de ses membres : on cherche ses amis, pas un nom d'équipe. Pendant un quiz, il ne bloque pas : le retardataire choisit son équipe en deux touchers, ou entre sans en un seul (« Entrer sans équipe ») et la choisira dans la salle d'attente — la question en cours n'attend pas. Depuis la salle d'attente, chacun peut encore se corriger tant qu'aucun quiz ne tourne — pendant une partie, c'est refusé : on ne change pas de camp entre deux questions.
...
**Chacun compte pour les questions qu'il a jouées.** La moyenne se fait question par question : pour chaque question, la moyenne des membres qui l'ont eue sous les yeux (le journal des réponses en garde une ligne par invité et par question posée, répondue ou non) ; la moyenne de l'équipe est la somme de ces moyennes. Chez les Randonneurs, Sofia et Hugo jouent la question 1 (200 et 164 points) : 182. Karim arrive à la question 2, que les trois jouent (100 chacun) : 182 + 100 = 282 — il comptait jusqu'ici pour la question 1 aussi, et la moyenne tombait à 121 à son arrivée. Inès choisit l'équipe après le quiz, sans avoir joué : elle en est membre, mais n'y change rien tant qu'elle n'a pas joué une question — elle faisait jusqu'ici tomber la moyenne de moitié, et changeait la gagnante d'un quiz déjà annoncé. Quand tout le monde a tout joué, c'est exactement la moyenne par membre d'avant.

**Chaque réponse garde son équipe.** Le journal retient, à chaque ligne, l'équipe du joueur au moment où elle s'écrit — aucune s'il n'en avait pas. La moyenne d'une équipe à une question se fait sur les lignes de cette question écrites pour elle : Malik, qui passe de la coloc aux invités après le quiz, laisse ses points à la coloc, et joue pour les invités à partir du quiz suivant ; Inès, connectée sans équipe pendant le quiz, a ses lignes à 0 mais ne compte pour personne quand elle rejoint les invités après coup. Un quiz joué ne change donc plus de vainqueur quand quelqu'un déménage. Les lignes d'avant cette colonne, qui n'en savent rien, se rangent sous l'équipe qu'a leur joueur dans l'archive. Le total, lui, reste la somme des points des membres du moment. La salle, le téléphone, le souvenir, le bilan (quiz par quiz compris) et l'historique lisent cette même règle (`shared/teams.ts`), les soirées archivées aussi.

**Les points d'équipe.** La moyenne rapporte à chaque équipe autant de points d'équipe que son rang le permet : avec six équipes, **6 à la première, 5 à la deuxième, … 1 à la dernière**. Les prix que l'animateur remet s'y ajoutent, et le plus de points d'équipe désigne l'équipe gagnante : un prix peut renverser l'ordre, c'est tout son intérêt — la remise des prix dit donc, sous chaque prix, ce qu'il changerait avant qu'on clique (« +1 pour 🎸 Guitaristes → à égalité en tête avec 🍝 Arrabbiata »), et le podium d'un quiz précise « avant les prix ». Un prix peut valoir 0 point, pour l'honneur : il se lit dans « Remis ce soir-là » sans rien changer. Deux équipes à égalité partagent le même rang et les mêmes points. Un seul tableau le montre, le même partout — téléphone, écran commun, souvenir —, rangé aux points d'équipe, prix compris, et une seule phrase l'explique.

**Côté animateur**, le panneau *Invités* regroupe les pastilles par équipe : on repère d'un coup d'œil qui s'est trompé, et un menu déroulant sur la pastille le déplace. On crée une équipe (nom + emoji), on la renomme, on la supprime — **supprimer une équipe n'exclut personne** : ses membres repassent « sans équipe » et gardent leurs points ; ce qu'ils avaient joué pour elle part avec elle. Le bouton ✨ crée d'un coup les équipes par défaut, de deux à six — une pour quatre invités, proposé, et six tant que personne n'est là —, à renommer ensuite.

**Entre deux questions**, l'écran commun annonce qui mène : les équipes d'abord, le top du quiz ensuite — c'est le classement d'équipe qui décide de la soirée. Chaque téléphone montre au même moment sa place dans le quiz — son rang, les places gagnées, celui qu'il talonne — et, juste dessous, où en est son équipe. Le rang est partagé : à égalité de points, deux invités lisent le même chiffre, plutôt qu'un ordre que personne n'a choisi.

**Le podium** bascule entre 👥 *Les équipes* (podium collectif et points d'équipe) et 🏆 *Les joueurs* (podium individuel et prix de caractère). Les deux comptent : le classement individuel fait jouer chacun, le classement d'équipe désigne le vainqueur de la soirée.
...
- cinq présentations refusées coupent la connexion socket ; une connexion ne crée pas plus de trois identités, une adresse pas plus de 60 d'un coup dans une même soirée (puis 60 par minute : le wifi d'une salle sort par une seule adresse — c'est l'écran commun qui en projette le QR —, et en 4G des dizaines d'invités partagent celle de leur opérateur ; à 25, la vague de scans qui suit l'apparition du QR prenait des refus) — la réserve se compte par soirée, pour que deux salles derrière la box d'une même école ne se ferment pas la porte, et une seconde, cinq fois plus large, borne une adresse sur tout le serveur —, et la soirée est complète au plafond réglé par l'animateur ;
...
**Sa place, à chaque révélation, ne coûte presque rien.** Chaque téléphone reçoit l'identifiant, les points et le rang du plus proche devant et du plus proche derrière, et son rang d'avant la question : 140 à 200 octets, lus dans le classement que la diffusion trie déjà une fois pour toute la salle. Le téléphone décore ses voisins avec l'instantané qu'il a déjà, et y lit « sur combien ». La contre-expertise (`retours/2026-09-25/classement-perf.md`), à 500 invités : 2 à 4 ms de plus par révélation sur la machine de mesure, invisibles sur une vraie salle de 480 — l'instantané renvoyé à chaque révélation y pèse 70 Ko par téléphone ; rien de plus pendant la question ; un retardataire qui entre pendant la révélation ne renvoie sa vue à personne, une exclusion seulement aux ex æquo de l'exclu. Seule une vague de reconnexions simultanées coûte un peu plus (+15 à 20 %) : chaque reconnexion trie le classement pour sa seule vue, comme avant.
...
L'écran commun a deux repères fixes : une bande d'état en haut (le titre de la soirée, quiz en cours, « Question 3 / 8 », combien ont répondu, QR et adresse pour rejoindre — et, quand la base en ligne refuse les écritures depuis une dizaine de secondes, une pastille discrète, « Sauvegarde en retard — la soirée continue », puisque la salle la voit aussi) et une **console animateur** en bas, toujours au même endroit — Révéler, Pause, Auto, Terminer, puis le son, le fond clair ou sombre, et le plein écran. Tenue au téléphone, cette console devient la télécommande (« Animer debout ») ; elle ne quitte pas l'écran commun pour autant : on peut toujours animer de l'ordinateur branché à la télé. « Terminer » est collé à « Auto », et la fin d'un quiz ne se rattrape pas : en pleine question, photo à mémoriser comprise, il demande confirmation ; pendant une révélation, il termine sans demander. L'espace animateur (`/edit`, `/compte`, `/admin`) partage la palette mais reste calme : pas d'animation, c'est un outil de travail, pas un spectacle.

**« Ivoire »** est Velours passé sur papier, pour l'écran commun quand le vidéoprojecteur ne rend pas les noirs : le fond devient crème (`#f9f5ec`), le noir chaud devient l'encre, le champagne s'assombrit (`#ac8536`) pour rester lisible, et les quatre teintes des formes foncent — le losange champagne disparaissait sur la crème. Ce sont aussi les couleurs des pages imprimées du bilan (`/<espace>/bilan/fiches`), qui les prennent d'office. Techniquement, c'est un second jeu de variables sous `:root[data-theme='ivoire']` dans la même feuille de style : rien d'autre ne change, ni les tailles, ni les polices, ni la mise en page. Le bouton de la console pose l'attribut sur la page et mémorise le choix (`client/src/theme.ts`) ; il n'est lu que sur `/host`, les téléphones n'en savent rien.

## Architecture

```
client/   React + Vite — les adresses (shared/adresses.ts, lues aussi par le serveur, qui y pose
          statut, 404 et balises d'aperçu : server/src/core/apercus.ts) : "/" et "/profil" (l'accueil : son
...
- **Teams** (`teams.ts`) — registre des équipes, séparé des joueurs : une équipe vit toute la soirée, ses membres vont et viennent. Le rattachement est une colonne sur le joueur, et chaque ligne du journal des réponses fige l'équipe de son moment : déplacer quelqu'un ne touche ni au journal des scores, ni aux quiz qu'il a déjà joués.
...
| 13 | Le bilan : ce que chacun a répondu question par question, la relecture collective, les pages à imprimer, l'export CSV | ✅ |
...
| 26 | La gestion des quiz (`retours/2026-09-25/gestion-des-quiz.md`) : les petits gestes de l'éditeur, le hasard d'une partie, le programme de la soirée, la bibliothèque qui se range, la mémoire des quiz, le partage par copie et onze modèles, ce qui entoure une question, et quatre nouvelles sortes — plusieurs réponses, l'ordre, « Qui dans la salle ? », l'estimation en direct — avec le blind test | ✅ |
