...
Une soirée rangée plusieurs fois est mise à jour, pas dupliquée : c'est la date et l'heure d'arrivée du premier invité **qui y a répondu** qui l'identifient — dans l'espace, deux animateurs peuvent avoir joué le même soir sans se gêner. Ce nom se tire une fois pour toutes — au plus tard quand quelque chose s'écrit sous lui dans la base permanente —, puis il est gardé, miroir compris : exclure le premier arrivé, presque toujours le téléphone d'essai de l'animateur, ou redémarrer le serveur ne le change plus. Seules la clôture et « C'était un essai » l'oublient ; la soirée suivante en tire un nouveau. Un invité venu sans jouer ne la date pas : l'invitée revenue relire la veille, entrée dans la soirée suivante sans y répondre, faisait archiver celle du 24 « du 17 ». Il se recalculait à chaque besoin, et une exclusion entre deux quiz rebaptisait la soirée : l'expérience s'écrivait sous deux noms et s'additionnait, et la soirée apparaissait deux fois dans l'historique.
