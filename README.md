...
**Sa place, à chaque révélation, ne coûte presque rien.** Chaque téléphone reçoit l'identifiant, les points et le rang du plus proche devant et du plus proche derrière, son rang d'avant la question et le nombre de joueurs : une centaine d'octets, lus dans le classement que la diffusion trie déjà une fois pour toute la salle — et le téléphone décore ses voisins avec l'instantané qu'il a déjà. Mesuré à 500 invités : environ 1 ms de plus par révélation, 150 octets de plus par téléphone, aucune vue de plus pendant la question, et un retardataire qui entre pendant la révélation ne renvoie sa vue à personne.
