...
**L'expérience** se gagne en venant jouer, et elle récompense d'abord d'être là : 50 points de présence, 1 par question répondue, 2 par bonne réponse, 60/40/25 pour le podium de la soirée et 15 par quiz remporté. Un niveau qui ne mesurerait que la culture générale n'aurait pas le goût d'une soirée entre amis. Les ex æquo partagent leur rang et touchent chacun la part entière : deux premiers de la soirée prennent 60 chacun, deux vainqueurs d'un même quiz 15 chacun. Une soirée ordinaire vaut environ 115 points ; les premiers niveaux tombent dans la soirée même, le niveau 10 demande huit soirées et le niveau 20 une trentaine.

Elle se crédite **dès que le podium d'un quiz s'affiche** — sans attendre « Terminer le quiz », qui ne vient parfois jamais : le dernier podium de la soirée reste souvent à l'écran jusqu'au bout de la nuit —, puis à la fin du quiz, et une dernière fois quand la soirée est rangée dans l'historique, juste avant que « Nouvelle soirée » n'efface les journaux. Le téléphone reçoit son profil à jour dans la foulée : « +115 points d'expérience », et le niveau affiché monte pendant la fête. La ligne `(profil, soirée)` est remplacée à chaque fois, jamais ajoutée : recalculer dix fois la même soirée ne crédite jamais deux fois, et l'annonce ne se répète pas quand le total n'a pas bougé. Les **badges**, eux, attendent l'archivage : ils se décernent sur la soirée entière — et chaque archivage remplace les prix de soirée du précédent. « Sauvegarder » à 21 h ne fige rien : c'est le dernier rangement qui fait foi.
...
- **Les prix de soirée** sont ceux que l'application proclame déjà en fin de fête — L'Éclair, Le Cancre Magnifique, Le Franc-Tireur… Il n'y a pas de second catalogue à tenir : ce que la salle a entendu annoncer est exactement ce qui se range dans les étagères. Ils se décrochent en une soirée, sur un coup d'éclat ou un coup de malchance, et se regagnent d'une fois sur l'autre (le compteur le dit). Tant que la soirée n'est pas finie, ils peuvent encore changer de main : chaque archivage les recalcule sur ce qui a été joué et remplace ceux du précédent, si bien qu'un prix n'a jamais qu'un lauréat — un invité exclu rend les siens. **On en gagne aussi en jouant mal** : Le Cancre et La Série Noire sont des prix, pas des punitions.
- **Les badges de carrière** récompensent une habitude plutôt qu'un soir : cinq soirées, cinq cents réponses, trois podiums, le niveau 10… Ils ne tombent qu'une fois, et ne se reprennent jamais. Ceux qui restent à décrocher sont montrés, avec leur règle — savoir ce qui vient donne envie de revenir.
...
**En fin de soirée**, le bouton 🏆 célèbre le classement cumulé en plein écran, avec un QR vers la **page souvenir** (`/romane/souvenir`) : podium, nombre de quiz, points distribués, le plus beau coup et le plus régulier — et, plus bas, toutes les statistiques. Elle est publique, à partager aux invités le lendemain. Sur tous les podiums, le rang est partagé : deux ex æquo en tête montent sur deux marches de premier, et le suivant est troisième.

**Entre deux soirées**, 🧹 Nouvelle soirée range d'abord la soirée dans l'historique (voir plus haut), puis efface invités et points, sauvegarde distante d'abord, disque local ensuite — les essais d'avant la fête ne doivent pas traîner dans le classement du soir J. Les téléphones encore ouverts sur l'ancienne soirée repassent par l'entrée, pré-remplie de leur prénom, écran d'équipe compris : ils n'ont qu'à confirmer pour rejoindre la suivante. Une archive d'essais se retire ensuite d'un clic sur `/romane/soirees`.
...
- **Progress** (`core/progress.ts`) — ce qu'une soirée rapporte aux profils qui l'ont jouée, dérivé des journaux par une fonction pure, comme le souvenir et le bilan. La consolidation, elle, se fait dans `space.ts` : dès le podium de chaque quiz (le « verdict » que lève le module de jeu), à sa fin, puis à l'archivage, la clé `(profil, soirée)` la rendant idempotente. Les prix de soirée se remplacent à chaque archivage, en un seul lot transactionnel (`remplacerPrixDeSoiree`) ; les badges de carrière, jamais.
